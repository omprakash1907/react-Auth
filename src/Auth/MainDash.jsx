        ...
        <div className='bg-theme vh-100  d-flex  justify-content-center  align-items-center '>
            <div className="intro-box p-4 text-center">
                ...
                <div className="d-flex justify-content-center ">
                    <button className='button-submit  bg-warning  rounded-1 px-4 me-2 ' onClick={()=>nevigate('/login')}>Join</button>
                    <button className='button-submit  bg-black border-2 border-black   rounded-1 px-4 text-white'>Sign In</button>
                </div>
            </div>
        </div>
    )
