...
import logo from '../Auth/image/Bumble-Logo.png'
                ...
                <div className='form'>
                    ...
                    <form className="mt-3 " onSubmit={handleSubmit}>
                        ...
                        <div className='w-100 text-center '>
                            <button className="button-submit  bg-warning  rounded-5 px-4" >Sign Up</button>
                        </div>
                        <p className="p">Already have an account? <Link className="span" to="/login">Sign In</Link>
